      ...
      <div className={classes.content}>
        <Grid container direction="row">
              ...
              <Typography>
                ...
                >
                  <a href="#" style={{ marginRight: '5px' }}>
                    <img src={`${BASE_IMG_S3}/social/facebook.png`} />
                  </a>
                  <a href="#" style={{ marginRight: '5px' }}>
                    <img src={`${BASE_IMG_S3}/social/Instagram.png`} />
                  </a>
                  <a href="#" style={{ marginRight: '5px' }}>
                    <img src={`${BASE_IMG_S3}/social/youtube.png`} />
                  </a>
                  <a href="#" style={{ marginRight: '5px' }}>
                    <img src={`${BASE_IMG_S3}/social/tiktok.png`} />
                  </a>
                </div>
              </Typography>
            </Box>
          ...
          <Grid item xs={12} lg={3} style={{ padding: '10px' }}>
            <img
              src={`${BASE_IMG_S3}/v1615853566/letsbeelife/mapVector_qwstap.png`}
            />
          </Grid>
        </Grid>
      </div>
